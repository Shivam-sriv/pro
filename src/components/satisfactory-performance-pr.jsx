...
const SatisfactoryperformanceConfirm = ({ show, setShow }) => {
      ...
      <div >
        <Modal className='rounded' show={show} onHide={() =>
          ...
          <Modal.Header closeButton >
            <Modal.Title className='fs-6'>Satisfactory Performance</Modal.Title>
          </Modal.Header>
          ...
          <Modal.Footer className='border-0'>
            <p className='fs-10 text-justify'>We've got some fantastic news for you! With the scheme consistently clocking returns within the acceptable range, we recommend you stay invested until suggested otherwise. <br /><a href='#' className='b-hover' onClick={openInnerModal}> To know more click here.</a></p>
...
export default SatisfactoryperformanceConfirm