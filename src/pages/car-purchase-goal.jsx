...
import CarGoal from "../../src/assets/images/car-g.png"
import Form from 'react-bootstrap/Form';
import { Link } from "react-router-dom";

const CarPurchaseGoal = () =>{
  return (
    <>
          ...
          <div className="container-fluid">
            <div className="row">
              ...
              <div className="row justify-content-center py-2 px-5">
                ...
                <div className="">
                  <img src={CarGoal} className="img-fluid mx-8 bg-goal mw-sm-5" />
                </div>
                <div className="">
               <h4 className="text-red">Car Purchase Goal</h4>
                </div>
                </div>
              </div>
              </div>
...
export default CarPurchaseGoal