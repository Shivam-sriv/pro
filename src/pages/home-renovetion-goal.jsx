...
import HRenovationGoal from "../../src/assets/images/home-go.png"
import Form from 'react-bootstrap/Form';
import { Link } from "react-router-dom";

const HomeRenovationGoal = () =>{
  return (
    <>
        ...
        <div className="report px-lg-5">
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb ps-3">
              ...
              <li className="breadcrumb-item active" aria-current="page">Home Renovation Goal</li>
            </ol>
          </nav>
        </div>
          ...
          <div className="container-fluid">
            <div className="row">
              ...
              <div className="row justify-content-center py-2 px-3">
                ...
                <div className="">
                  <img src={HRenovationGoal} className="img-fluid mx-8 bg-goal mw-sm-5" />
                </div>
                <div className="">
               <h4 className="text-red">Home Renovation Goal</h4>
                </div>
                </div>
              </div>
              </div>
...
export default HomeRenovationGoal