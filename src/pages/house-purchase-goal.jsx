...
import HouseGoal from "../../src/assets/images/home-go.png"
import Form from 'react-bootstrap/Form';
import { Link } from "react-router-dom";

const HousePurchaseGoal = () =>{
  return (
    <>
        ...
        <div className="report px-lg-5">
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb ps-3">
              ...
              <li className="breadcrumb-item active" aria-current="page">House Purchase Goal</li>
            </ol>
          </nav>
        </div>
        ...
        <section>
          <div className="container-fluid">
            <div className="row">
              ...
              <div className="row justify-content-center py-2 px-4">
                <div className="col-md-4 d-flex justify-content-between align-items-baseline">
                <div className="">
                  <img src={HouseGoal} className="img-fluid mx-8 bg-goal mw-sm-5" />
                </div>
                <div className="">
               <h4 className="text-red">House Purchase Goal</h4>
                </div>
                </div>
              </div>
              </div>
...
export default HousePurchaseGoal