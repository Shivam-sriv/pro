        ...
        <div className="report px-lg-5">
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb ps-3">
              ...
              <li className="breadcrumb-item active" aria-current="page">Vacation Goal</li>
            </ol>
          </nav>
        </div>
        <section>
          <div className="container-fluid">
            <div className="row">
              ...
              <div className="row justify-content-center py-2 px-5">
                ...
                <div className="">
                  <img src={Vacation} className="img-fluid mx-8 bg-goal mw-sm-5" />
                </div>
                <div className="">
               <h4 className="text-red">Vacation Goal</h4>
                </div>
                </div>
              </div>
              </div>
