              ...
              <div className="col-md-12 bg-light-red mb-5">
                <div className="row justify-content-center py-2 px-4">
                  <div className="col-md-4 d-flex justify-content-between align-items-baseline">
                    <div className="">
                      <img src={Wealth} className="img-fluid mx-8 bg-goal mw-sm-5" />
                    </div>
                    <div className="">
                      <h4 className="text-red"> Wealth Creation Goal</h4>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="row justify-content-center">
              <div className="col-md-6 shadow-custom p-lg-4 p-5">
                <Form className="text-start pb-5 px-lg-5">
                  ...
                  >
                    <h6>
                      How much money would you need to achieve this goals?{" "}
                    </h6>
                ...
                <div className="text-lg-end text-center">
                  <Link to="/dashboard/goal-summary" className="btn-custom">
                    Add Goal
                  </Link>
                </div>
              </div>
...
export default WealthCreationGoal;
